...
// ];
// List<String> des = [
// "Python is one of the most popular and fastestprogramming language since half a decade.\nIf You think you have learnt it.. \nJust test yourself !!",
// "Java has always been one of the best choices forEnterprise World. If you think you have learn the Language...\nJust Test Yourself !!",
...
// "Linux is a OPEN SOURCE Operating System which powers many Servers and Workstation.\nIt is also a top Priority inDevelopement Work !",
// ];
// Widget customcard(String langname, String image, String
// des){
// return Padding(
...
// // in changelog 1 we will pass the langname
// //name to ther other widget class
// // this name will be used to open a particular
// //JSON file
...
// child: Container(
//   // changing from 200 to 150 as to
// //look better
// height: 150.0,
// width: 150.0,
// child: ClipOval(
